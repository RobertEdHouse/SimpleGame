...
public final class FragmentTimerBinding implements ViewBinding {
  ...
  private FragmentTimerBinding(@NonNull RelativeLayout rootView, @NonNull Button quitButton,
  ...
  public static FragmentTimerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTimerBinding((RelativeLayout) rootView, quitButton, timerText);
    }
